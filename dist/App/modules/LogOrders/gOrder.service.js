...
const getAllOrder = ({ startDate, endDate, searchTerm }) => __awaiter(void 0, void 0, void 0, function* () {
    if (startDate) {
...
const getLogOrderById = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    if (!payload.voucherNo) {
        throw new AppError_1.default(http_status_codes_1.StatusCodes.BAD_REQUEST, "Voucher no is required");
    }
