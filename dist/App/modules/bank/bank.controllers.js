...
const getBankLedger = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { accountId, fromDate, toDate } = req.query;
    const accountIdNumber = parseInt(accountId, 10);
    const result = yield bank_service_1.BankAccountService.getBankLedger(accountIdNumber, fromDate, toDate);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
