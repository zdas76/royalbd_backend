...
const getVoucherbyVoucherNo = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const voucherNo = req.params.voucherNo;
    const result = yield transction_service_1.VoucherService.getVoucherByVoucherNo(voucherNo);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_codes_1.StatusCodes.OK,
        success: true,
